...
3. **Площадка для hybrid cyber ranges.** Соединяет симулированные сервисы и
   реальные виртуальные машины через общий event bus — от маленького старта
...
На уровне событий движок обращается ко всем трём одинаково. Разница — кто
отвечает на событие: сам движок или внешний наблюдатель (`cybercity-collector`).
